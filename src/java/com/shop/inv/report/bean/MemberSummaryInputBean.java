 ...
 */
public class MemberSummaryInputBean {
     /*-------for access control-----------*/
    ...
    //Table data
    private List<MemberSummaryBean> gridModel=new ArrayList<MemberSummaryBean>();
    ...
    public List<MemberSummaryBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<MemberSummaryBean> gridModel) {
